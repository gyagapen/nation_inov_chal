...
class InsertCirclePage extends StatefulWidget {
  InsertCirclePage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _InsertCirclePageState createState() => new _InsertCirclePageState();
}

class _InsertCirclePageState extends State<InsertCirclePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Stack(
      children: [
        new Scaffold(
          appBar: new AppBar(title: new Text("Create Circle")),
          body: new ListView(
  ...
  void _submitForm() {
    ...
    if (!form.validate()) {
      ...
      //submit to server
      ServiceHelpRequest
          .insertCircle(storedUiD, _name, _number)
          .then((response) {
